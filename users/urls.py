...
urlpatterns = [
    ...
    path('private-users/', UserListPrivateView.as_view(), name='user-list-private'),
    path('private-users/<int:id>/', UserDetailPrivateView.as_view(), name='user-detail-private'),
